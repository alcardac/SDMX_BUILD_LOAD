...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            multiple: true,
            dragDrop: true,
            dragDropBorder: '1px solid #000000',
            dragDropBorderHover: '2px solid #000000',
            autoSubmit: true,
            showCancel: true,
            showAbort: true,
            showDone: true,
            ...
            statusbarButtonClass: "ajax-file-upload-statusbar",
        ...
        var formGroup = "ajax-file-upload-item"+ (new Date().getTime());
        ...
        function setDragDropHandlers(obj, s, ddObj) {
            ddObj.on('dragenter', function (e) {
                e.stopPropagation();
                e.preventDefault();
                $(this).css('border', s.dragDropBorder);
            });
            ...
            ddObj.on('drop', function (e) {
                $(this).css('border', s.dragDropBorderHover);
                e.preventDefault();
                obj.errorLog.html("");
                var files = e.originalEvent.dataTransfer.files;
                if (!s.multiple && files.length > 1) {
                    if (s.showError) $("<div style='color:red;'>" + s.multiDragErrorStr + "</div>").appendTo(obj.errorLog); return;
                }
            ...
            $(document).on('dragover', function (e) {
                e.stopPropagation();
                e.preventDefault();
                ddObj.css('border', s.dragDropBorderHover);
            });
            $(document).on('drop', function (e) {
                e.stopPropagation();
                e.preventDefault();
                ddObj.css('border', s.dragDropBorder);
            });
        ...
        function createProgressDiv(obj, s) {
            this.statusbar = $("<div class='ajax-file-upload-statusbar " + s.statusbarButtonClass + "' ></div>");
